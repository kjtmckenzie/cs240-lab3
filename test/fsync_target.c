 ...
 * fsync_target.c
 *
 * Exercises basic filesystem operations in a test directory, and calls
 * fsync() at various times. Used to test the effect of intercepting fsync()
 * on correct filesystem operation.
 */
